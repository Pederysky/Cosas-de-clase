# Escribe un programa que simule un juego en el que dos jugadores lanzan su propio dado. 
# Tras cada tirada se mostrará el valor obtenido en el lanzamiento y el total obtenido hasta  ese instante por cada jugador. 
# Tras cada tirada se preguntará a cada uno de los jugadores si quieren volver a lanzar el dado o si desean terminar su partida.
